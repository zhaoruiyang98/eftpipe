...
dcts = [
    ...
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"accboost": 1, "kout": None}}},
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"accboost": 1, "kout": [4, 5, 6]}}},
]
...
expect = [
    ...
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"kout": kout}}},
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"accboost": 1, "kout": kout}}},
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"accboost": 1, "kout": kout}}},
    {"z": 0.3, "config_settings": {"with_binning": True, "binning": {"accboost": 1, "kout": kout}}},
]
